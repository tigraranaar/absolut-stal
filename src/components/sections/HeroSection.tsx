        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          ...
          <div className="text-center lg:text-left">
            <h1 className="mb-6 text-4xl leading-tight font-bold text-white lg:text-6xl">
              <span className="text-yellow-400">Металлопрокат Ижевск</span>
              <br />
              Купить металлопрокат в Ижевске
            </h1>
            <p className="mb-8 text-xl leading-relaxed text-gray-200">
              ...
              проволока, сетка, катанка, квадрат, шестигранник. Продажа
              металлопроката оптом и в розницу. Профессиональная резка металла,
              доставка по Ижевску и Удмуртии.
            </p>
          </div>
