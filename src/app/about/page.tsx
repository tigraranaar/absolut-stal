...
export const metadata = {
  title: 'Компания металлопрокат Казань - Металлобазa Казань | Абсолют Сталь',
  description:
    'Компания металлопрокат Казань - Абсолют Сталь. Металлобазa Казань с широким ассортиментом: арматура, трубы, профнастил, лист стальной, уголок, швеллер, балка. Продажа металлопроката оптом и в розницу. Наша история, преимущества и опыт работы.',
  keywords:
    'компания металлопрокат Казань, металлобазa Казань, продажа металлопроката Казань, металлопрокат оптом Казань, о компании Абсолют Сталь, поставщик металла Казань, история компании, металлопрокат Казань',
  alternates: {
    canonical: 'https://казаньметалл.рф/about',
  },
  openGraph: {
    type: 'website',
    locale: 'ru_RU',
    url: 'https://казаньметалл.рф/about',
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Компания &quot;Абсолют Сталь&quot; была основана в 2018 году с
