      ...
      <section className="bg-gradient-to-br from-gray-50 to-gray-100 py-20">
        <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          <h1 className="mb-6 text-4xl font-bold text-gray-900 lg:text-6xl">
            Контакты{' '}
            <span className="text-yellow-500">металлопрокат Ижевск</span>
          </h1>
          <p className="mx-auto max-w-3xl text-xl text-gray-600">
            Свяжитесь с нами для заказа металлопроката в Ижевске: арматура,
            трубы, профнастил, лист стальной, уголок, швеллер, балка, круг
            стальной, проволока, сетка, катанка, квадрат, шестигранник, пруток.
            Наши специалисты готовы помочь с выбором материалов и ответить на
            все вопросы.
          </p>
        </div>
      </section>
